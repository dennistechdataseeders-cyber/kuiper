...
const getWelcomeTemplate = (name, email, password, role,host_url) => {
...
">
  ...
  <div style="margin-bottom:28px;">
    ...
    <p style="margin-top:8px; font-size:13px; color:#475569; line-height:1.5;">
        ...
        Please follow the security protocols below to activate your account.
    </p>
  </div>
  ...
  <div style="
    ...
    margin-bottom: 32px;
  ">
    <div style="font-size:11px; font-weight:800; color:#0f172a; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:12px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td style="padding-bottom:12px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="24" valign="top" style="font-size:12px; font-weight:bold; color:#2563eb;">01.</td>
              <td style="font-size:12px; color:#475569; line-height:1.4;">
                Access the <strong>KUIPER Dashboard</strong> using the button below.
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td style="padding-bottom:12px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="24" valign="top" style="font-size:12px; font-weight:bold; color:#2563eb;">02.</td>
              <td style="font-size:12px; color:#475569; line-height:1.4;">
                Locate the <strong>User Icon</strong> at the bottom of the sidebar and select <strong>Change Password</strong>.
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="24" valign="top" style="font-size:12px; font-weight:bold; color:#2563eb;">03.</td>
              <td style="font-size:12px; color:#475569; line-height:1.4;">
                Enter your temporary password followed by your new secure credential to finalize activation.
              </td>
            </tr>
          </table>
        </td>
